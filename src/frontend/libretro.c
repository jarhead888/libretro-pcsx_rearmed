...
static void update_input_guncon(int port, int ret)
{
	...
	gunx = input_state_cb(port, RETRO_DEVICE_POINTER, 0, RETRO_DEVICE_ID_POINTER_X);
	guny = input_state_cb(port, RETRO_DEVICE_POINTER, 0, RETRO_DEVICE_ID_POINTER_Y);
	//Mouse range is -32767 -> 32767, 1% is about 65, Use the left analog stick field to store the absolute coordinates
